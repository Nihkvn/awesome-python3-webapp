     ...
     <!--        <div class="error btns login-form-tips" id="jsLoginTips" v-show="error"><p>用户名或密码错误</p></div> -->
          ...
          <ul class="form other-form">
            ...
            <li class="other-login">
              <a class="qq" href="http://127.0.0.1:8080/login/qq/"></a>
              <a class="sina" href="http://127.0.0.1:8080/login/weibo/"></a>
              <a class="weixin" href="http://127.0.0.1:8080/login/weixin/"></a>
            </li>
          </ul>
          <p class="form-p">
            没有帐号？
